...
<body class="light-page">
              ...
              <?php $this->load->view("Front/Templates/BetstoreTemplates/Navigation"); ?>
                <div class="row">
                    <div class="col-md-12 ml-auto mr-auto mt-50">
                      <?php $this->load->view("Front/Templates/BetstoreTemplates/TableTemplate1", $data); ?>
                    </div>

                    <div class="next-page">
                        <a href="<?php echo base_url('betstore/Under25') ?>" class="btn btn-primary ">View Under 2.5</a>
                    </div>
                </div>
            </div>
            <div class="bg-wrap">
    ...
    $(document).ready(function () {
        ...
        $('.time-nav-item').click(function () {
            ...
            $.post('<?php echo base_url("betAjax/Over25/'+ matchDate +'") ?>')
            .done(function (data) {
                console.log(data);
