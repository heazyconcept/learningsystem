<?php $data["PageTitle"] = "Edit Testimonial - 90minsbet"; $data["PresentMenu"] = "testimonials"; ?>
                ...
                <div class="col-md-5">
                    <div class="row row-sm">
                        <div class="col-lg-12">
                            <div class="form-group has-success mg-b-0">
                                ...
                                <input class="form-control" name="FullName" placeholder="Enter the Fullname" required
                                    type="text" value = "<?php echo $TestimonialData->FullName; ?>">
                            </div><!-- form-group -->
                        </div><!-- col -->
                        <div class="col-lg-12 mg-t-20">
                            <div class="form-group has-success mg-b-0">
                                ...
                                <select class="form-control select2" required name="Country">
                                    ...
                                    <option  value="<?php echo $country->name ?>" <?php echo ($country->name == $TestimonialData->Country)? 'selected': ''; ?> ><?php echo $country->name ?></option>
                                    <?php } ?>
                                </select>
                            </div><!-- form-group -->
                        </div><!-- col -->
                        ...
                        <div class="col-lg-12 mg-t-20">
                            ...
                            <textarea name="Testimony" class="form-control" type="text"><?php echo $TestimonialData->Testimony; ?></textarea>
                        </div><!-- col-4 -->
                        <div class="col-md-12 mg-t-20">
                            <label class="form-label mg-b-10">Make Active</label>
                            <div class="az-toggle-group-demo">
                                <div id="IsActive" class="az-toggle az-toggle-success <?php echo ( $TestimonialData->IsActive == 1)? 'on': ''; ?>"><span></span></div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#TestimonialForm').on('submit', function (e) {
            ...
            AjaxInit("<?php echo base_url('adminAjax/EditTestimonial/'. $TestimonialData->Id) ?>", formData, false, true);
